            ...
            <div className="bg-white p-4 rounded-md">
                ...
                <div className="mt-2 text-sm font-semibold text-gray-600">
                  * Avansul de{" "}
                  <span className="text-black">
                    {CONST_ADVANCE_PAYMENT_PRICE} RON
                  </span>{" "}
                  este necesar indiferent de opțiunea aleasă.
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <p className="mt-2 text-sm leading-5">
                  Mai jos aveți detaliile despre cursul de baza - MODULUL
                  STANDARD ✨<br />
                  🧠Acest modul de curs l-am gândit ca fiind ideal pentru
                  bobocii care doresc să învețe tehnicile fundamentale și să
                  intre cu ușurință în această industrie.
                </p>
                <p className="text-sm pt-3 font-semibold">
                  ✅Scopul meu este să îți ofer o BAZĂ SOLIDĂ, pentru a putea
                  aplica corect extensii de la 1D pana la 3D.{" "}
                </p>
              </div>
              <div className="mt-4">
              ...
              <div className="mt-4">
                ...
                <div className="flex gap-2 mt-2 flex-wrap items-center">
                  ...
                  >
                    <span
                      className={promoCodeLoading ? "invisible" : "visible"}
                    >
                      Verifică
                    </span>
                    {promoCodeLoading && (
