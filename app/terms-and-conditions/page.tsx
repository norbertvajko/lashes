                ...
                <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                        ...
                        <AccordionContent>
                            ...
                            <b>1.2 UTILIZATOR</b> – persoana fizica sau juridica de drept public sau privat care are sau obtine acces la CONTINUT, prin orice mijloc de comunicare (electronic, telefonic, etc) sau in baza unui acord de utilizare intre LL LASHES SA si acesta.<br /><br />
                            ...
                            <b>1.4 CLIENT</b> – Persoana fizica sau juridica de drept public sau privat care are sau obtine acces la CONTINUT si SERVICIU, prin orice mijloc sau in baza unui acord de utilizare intre LL LASHES SA si acesta, sau persoana fizica sau juridica care beneficiaza de pe urma produselor si/sau serviciilor oferite de LL LASHES SA si achizitionate de catre acesta prin folosirea SERVICIULUI.<br /><br />

                            <b>1.5 DOCUMENT</b> – prezentele Termeni si Conditii<br /><br />

                            <b>1.6 BULETIN</b> INFORMATIV / NEWSLETTER – mijlocul de informare periodic, exclusiv electronic, asupra produselor, serviciilor si/sau promotiilor desfasurate de catre LL LASHES SA intr-o anumita perioada, fara nici un angajament din partea LL LASHES SA cu referire la informatiile continute de acesta.<br /><br />

                            <b>1.7 TRANZACTIE</b> – incasare sau rambursare a unei sume rezultata din vanzarea unui produs / serviciu de catre LL LASHES SA catre Client indiferent de modalitatea de livrare. <br /><br />
                    ...
                    <AccordionItem value="item-2">
                        ...
                        <AccordionContent>
                            <b>2.1</b> Acest document stabileste termenii si conditiile de utilizare ai site-ului/continutului/serviciului de catre utilizator sau client, in cazul in care acesta nu dispune de un alt acord de utilizare valid, incheiat intre LL LASHES SA, str. Piersicilor 23, jud Arad, Arad.<br /><br />
                            ...
                            <b>2.5</b> De asemenea, acesta raspunde pentru orice daune materiale, intelectuale sau electronice sau de orice alta natura produse site-ului, continutului, serviciului, LL LASHES SA sau oricarui tert cu care LL LASHES SA are incheiate contracte, in conformitate cu legislatia romana in vigoare.
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-5">
                        ...
                        <AccordionContent>
                            <b>5.1</b> LL LASHES SA isi rezerva dreptul de a modifica tarifele practicate pentru produsele si/sau serviciile disponibile pe site fara notificarea prealabila a Utilizatorului / Clientului.<br /><br />
